    ...
    <div className={styles.footerComp}>
      <div className={styles.footerTop}>
        <div className={styles.alightLogo}>
          <img src={require('../assets/logo.png')} alt='Alight Logo' />
        </div>
        ...
        <div className={styles.alightLinks}>
          <a className={styles.linkText} href="https://alight.eu/en/" target='_blank'>Home</a>
          <div className={styles.bar}></div>
          <a className={styles.linkText} href="https://alight.eu/en/solutions/"target='_blank'>Solutions</a>
          <div className={styles.bar}></div>
          <a className={styles.linkText} href="https://alight.eu/en/technologies/" target='_blank'>Technologies</a>
          <div className={styles.bar}></div>
          <a className={styles.linkText} href="https://alight.eu/en/references/" target='_blank'>References</a>
          <div className={styles.bar}></div>
          <a className={styles.linkText} href="https://alight.eu/en/about-us/" target='_blank'>About Us</a>
        </div>
      </div>
